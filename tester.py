...
problems = [
 ...
 problem10, problem11, problem12, problem13, problem14, problem15, problem16, problem17
]

def solve_game(ind, problem, example, debug_mode):
    start = time.time()
    game = pressure_plate.create_pressure_plate_game((100, problem, example, debug_mode))
    solve(game)
    end = time.time()
    print("###############################################")
